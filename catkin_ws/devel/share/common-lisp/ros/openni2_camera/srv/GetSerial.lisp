...
(cl:in-package openni2_camera-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <GetSerial-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetSerial-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openni2_camera-srv:<GetSerial-request> is deprecated: use openni2_camera-srv:GetSerial-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetSerial-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetSerial-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name openni2_camera-srv:<GetSerial-response> is deprecated: use openni2_camera-srv:GetSerial-response instead.")))

(cl:ensure-generic-function 'serial-val :lambda-list '(m))
(cl:defmethod serial-val ((m <GetSerial-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader openni2_camera-srv:serial-val is deprecated.  Use openni2_camera-srv:serial instead.")
  (serial m))
